    ...
    <div
        ...
        <div class="navbar bg-base-100">
            ...
            <div class="flex flex-1 md:gap-1 lg:gap-2">
                <router-link to="/" aria-current="page" aria-label="Homepage" class="btn-ghost btn px-2">
                    <div class="text-primary inline-flex text-lg transition-all duration-200 md:text-3xl">
                        <span class="text-primary">H<span class="lowercase">omestead</span></span>
                ...
                <div>
                    <span class="tooltip tooltip-bottom before:text-xs before:content-[attr(data-tip)]"
                        ...
                        <div class="flex-none items-center">
                            <a aria-label="Github" target="_blank" href="https://github.com/jmobley09/homestead"
